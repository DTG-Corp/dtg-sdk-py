...
from dtgsoft.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from dtgsoft.core.request_options import RequestOptions
...
@patch("dtgsoft.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("dtgsoft.core.http_client.asyncio.sleep", new_callable=AsyncMock)
